...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/raoever/sistemaBancario/maven[GitHub Workflow Status]
